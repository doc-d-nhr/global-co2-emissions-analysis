...
**Data source:** Our World in Data, CO2 and Greenhouse Gas Emissions dataset — [github.com/owid/co2-data](https://github.com/owid/co2-data),  OWID's data is itself compiled from the Global Carbon Project, so credit really goes further upstream than just OWID.
